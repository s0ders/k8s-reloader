...
*/}}
{{- define "k8s-reloader.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "k8s-reloader.resourceName" -}}
{{- $fullname := include "k8s-reloader.fullname" .context }}
{{- $suffix := .suffix }}
