...
func (r *ReplicaSetReloaderReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	return GenericReconcile(
		...
		req,
		r.Client,
		func(req ctrl.Request) (*appsv1.ReplicaSet, error) {
		...
		func(obj *appsv1.ReplicaSet) map[string]string {
			return obj.Spec.Template.Annotations
		},
		func(obj *appsv1.ReplicaSet, annotations map[string]string) {
...
func (r *ReplicaSetReloaderReconciler) findReplicaSetsForConfigMap(ctx context.Context, obj client.Object) []reconcile.Request {
	return FindWorkloadsForConfigMap(ctx, r.Client, obj, func(ctx context.Context, namespace string) ([]*appsv1.ReplicaSet, error) {
		var list appsv1.ReplicaSetList
		err := r.List(ctx, &list, client.InNamespace(namespace))

		pointerList := make([]*appsv1.ReplicaSet, len(list.Items))
...
func (r *ReplicaSetReloaderReconciler) findReplicaSetsForSecret(ctx context.Context, obj client.Object) []reconcile.Request {
	return FindWorkloadsForSecret(ctx, r.Client, obj, func(ctx context.Context, namespace string) ([]*appsv1.ReplicaSet, error) {
		var list appsv1.ReplicaSetList
		err := r.List(ctx, &list, client.InNamespace(namespace))
